//
//  CheekLstatAtLnkViewController.m
//  A0CrackMe
//
...
#define FLAG @"jailBreakCheekLstatAtLnk"

#import <Foundation/Foundation.h>

#import "CheekLstatAtLnkViewController.h"
#import "JailBreakCheek.h"
#import "CrackArrayDefaults.h"
#import "Tools.h"

@interface CheekLstatAtLnkViewController ()

@end

@implementation CheekLstatAtLnkViewController
...
- (void)viewDidLoad {
    ...
    [desc setText:@"越狱检测 检测路径是否存及是否是链接路径"];
...
- (void)check{
    ...
    Boolean result = [JailBreakCheek isLstatAtLnk];
    if (!result){
        // 改变值
