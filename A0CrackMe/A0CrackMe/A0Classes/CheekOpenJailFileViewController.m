//
//  CheekOpenJailFileViewController.m
//  A0CrackMe
//
...
#define FLAG @"jailBreakCheekOpenJailFile"

#import <Foundation/Foundation.h>

#import "CheekOpenJailFileViewController.h"
#import "JailBreakCheek.h"
#import "CrackArrayDefaults.h"
#import "Tools.h"

@interface CheekOpenJailFileViewController ()

@end

@implementation CheekOpenJailFileViewController
...
- (void)check{
    ...
    Boolean result = [JailBreakCheek isOpenJailFile];
    if (!result){
        // 改变值
