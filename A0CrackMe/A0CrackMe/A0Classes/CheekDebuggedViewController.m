...
#define FLAG @"jailBreakCheekDebugged"

#import <Foundation/Foundation.h>

#import "CheekDebuggedViewController.h"
#import "JailBreakCheek.h"
#import "CrackArrayDefaults.h"
#import "Tools.h"

@interface CheekDebuggedViewController ()

@end

@implementation CheekDebuggedViewController
...
- (void)viewDidLoad {
    ...
    [desc setText:@"越狱检测 检测是否是debugger模式"];
