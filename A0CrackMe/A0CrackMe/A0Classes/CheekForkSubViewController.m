...
#define FLAG @"jailBreakCheekForkSub"

#import <Foundation/Foundation.h>

#import "CheekForkSubViewController.h"
#import "JailBreakCheek.h"
#import "CrackArrayDefaults.h"
#import "Tools.h"

@interface CheekForkSubViewController ()

@end

@implementation CheekForkSubViewController
...
- (void)check{
    ...
    Boolean result = [JailBreakCheek isForkSub];
    if (!result){
        // 改变值
