//
//  CheekOpenJailAppViewController.m
//  A0CrackMe
//
...
#define FLAG @"jailBreakCheekOpenJailApp"

#import <Foundation/Foundation.h>

#import "CheekOpenJailAppViewController.h"
#import "JailBreakCheek.h"
#import "CrackArrayDefaults.h"
#import "Tools.h"

@interface CheekOpenJailAppViewController ()

@end

@implementation CheekOpenJailAppViewController
...
- (void)check{
    ...
    Boolean result = [JailBreakCheek isOpenJailApp];
    if (!result){
        // 改变值
